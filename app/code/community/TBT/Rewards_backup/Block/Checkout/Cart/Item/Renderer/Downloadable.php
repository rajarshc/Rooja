 ...
 */
class TBT_Rewards_Block_Checkout_Cart_Item_Renderer_Downloadable extends TBT_Rewards_Block_Checkout_Cart_Item_Renderer {
	...
	public function getLinks() {
		...
		if ($linkIds = $this->getItem ()->getOptionByCode ( 'downloadable_link_ids' )) {
			$productLinks = $this->getProduct ()->getTypeInstance ( true )->getLinks ( $this->getProduct () );
