...
class GoldenSpiralStudio_OneClickCartCheckout_Block_Adminhtml_OneClickCheckout_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    ...
    public function getHeaderText()
    {
        if( Mage::registry('oneclickcartcheckout_data') && Mage::registry('oneclickcartcheckout_data')->getId() ) {
            return Mage::helper('oneclickcartcheckout')->__("Edit Item '%s'", $this->htmlEscape(Mage::registry('oneclickcheckout_data')->getTitle()));
        } else {
