...
class Mage_Adminhtml_Block_Sales_Invoice_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    protected function _prepareMassaction()
    {
        ...
        $this->getMassactionBlock()->addItem('pdfinvoices_order', array(
             'label'=> Mage::helper('sales')->__('PDF Invocices'),
             'url'  => $this->getUrl('*/sales_invoice/pdfinvoices'),
        ));

		
        $this->getMassactionBlock()->addItem('invoice_export', array(
             'label'=> Mage::helper('sales')->__('Invoice Export'),
             'url'  => $this->getUrl('*/sales_invoice/exportinvoices'),
        ));
