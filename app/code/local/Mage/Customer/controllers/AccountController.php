...
class Mage_Customer_AccountController extends Mage_Core_Controller_Front_Action
{
	...
	public function preDispatch()
	{
		...
		$pattern = '/^(create|login|logoutSuccess|forgotpassword|forgotpasswordpost|confirm|confirmation|ajaxLogin|ajaxForgotPassword|ajaxCheckEmail|ajaxCreate|ajaxCreateOnBoard)/i';
...
public function ajaxCreateOnBoardAction()
	{
		$session = $this->_getSession();
		if ($session->isLoggedIn()) {
			$this->_redirect('*/*/');
	...
	public function ajaxCheckEmailAction()
	{
		...
		if ($email) {
			...
			if ($customer->getId()) {									
					$result['success'] = false;
					$result['message'] = $this->__('Email Address already registered!');
					$this->getResponse()->setBody(Zend_Json::encode($result));
