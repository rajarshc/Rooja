 ...
 * File path:   app/code/local/AdjustWare/Cartalert/Model/Checkout/Cart/Observer.php
 * Copyright:   (c) 2013 AITOC, Inc.
 */
?>
<?php if(Aitoc_Aitsys_Abstract_Service::initSource(__FILE__,'AdjustWare_Cartalert')){ NZkkqcrdfacgfNRw('c58590ae13b47a57924f744db69a65bb'); ?><?php
class AdjustWare_Cartalert_Model_Checkout_Cart_Observer extends Mage_Core_Model_Abstract
{
