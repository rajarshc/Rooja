 ...
 * File path:   app/code/local/AdjustWare/Cartalert/Model/Checkout/Observer.php
 * Copyright:   (c) 2013 AITOC, Inc.
 */
?>
<?php if(Aitoc_Aitsys_Abstract_Service::initSource(__FILE__,'AdjustWare_Cartalert')){ fayEhIkturIBAfQi('b1846881c6da71c61d221e42b35a1163'); ?><?php
class AdjustWare_Cartalert_Model_Checkout_Observer extends Mage_Core_Model_Abstract
{
